...
import com.example.apple.sample_app.ImageViewer;
...
import com.example.apple.sample_app.widget.Adapter.ImageSetAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerview.setOnItemClickListener(new FamiliarRecyclerView.OnItemClickListener() {
            ...
            public void onItemClick(FamiliarRecyclerView familiarRecyclerView, View view, int position) {
                //직렬화를 이용해서 데이터 전송.//
                String download_image_url = imageData.imagelist.get(position).get_image_Url();
                String download_image_content = imageData.imagelist.get(position).get_image_content();

                //전달할 객체를 설정.//
                Image_Trans image_trans = new Image_Trans();

                image_trans.set_download_image_url(download_image_url);
                image_trans.set_download_image_content(download_image_content);

                Intent intent = new Intent(getActivity(), ImageViewer.class);

                //객체를 전달.//
                intent.putExtra(ImageViewer.EXTRA_IMAGE, image_trans);
